...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const ROUTE_FUNCTIONS = {
      ...
      "/pages/listings/index.html": [viewAllListings, searchForListing, viewProfileImg, navFix],
      "/pages/specific/index.html": [viewSpecificListing, viewProfileListings, viewProfileImg, showCreditAmount, navFix],
      "/pages/profile/index.html": [viewProfileInfo, viewUserListings, updateAvatarURL, viewForm, createListingForm, changeAvatarButton, viewProfileImg, navFix, viewBiddingHistory]
  };

  // Retrieves the list of functions to run based on the current route
  const functionsToRun = ROUTE_FUNCTIONS[normalizePath(window.location.pathname)];
